#!/usr/bin/env python3
"""Validate the exact public CORE v11.5.1 DSK v3 candidate manifest."""
...
SCHEMA_VERSION = "core.frozen_release_manifest.v8"
SCHEMA_PATH = PROJECT_ROOT / "schemas" / "core" / "frozen_release_manifest.v8.json"
RELEASE_VERSION = "v11.5.1"
INVENTORY_PROFILE = "core.dsk_v3_release.v11_5_1_candidate"
...
def required_v11_5_1_candidate_artifacts() -> dict[str, str]:
    ...
    expected.update({
        ...
        "schemas/core/frozen_release_manifest.v8.json": "schema",
        "scripts/validate_dsk_v3.py": "script",
        "scripts/build_frozen_release_manifest_v11_5_1.py": "script",
        "scripts/validate_frozen_release_manifest_v11_5_1.py": "script",
        "docs/releases/v11.5.1.md": "documentation",
        "tests/test_dsk_v3.py": "test",
        "tests/test_frozen_release_manifest_v11_5_1.py": "test",
...
def build_v11_5_1_candidate_manifest(created_at: str) -> dict[str, Any]:
...
def validate_v11_5_1_release_manifest(path: Path, *, verify_live_artifacts: bool = False) -> dict[str, Any]:
    try:
...
def main() -> int:
    if len(sys.argv) not in {2, 3} or (len(sys.argv) == 3 and sys.argv[2] != "--verify-live-artifacts"):
        ...
        return 2
    result = validate_v11_5_1_release_manifest(Path(sys.argv[1]), verify_live_artifacts=len(sys.argv) == 3)
