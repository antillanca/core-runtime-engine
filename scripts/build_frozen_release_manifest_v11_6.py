#!/usr/bin/env python3
"""Build the CORE v11.6.0 stabilization frozen release candidate manifest."""
...
def main() -> int:
    ...
    manifest = build_v11_6_candidate_manifest(datetime.now(timezone.utc).strftime("%Y-%m-%dT%H:%M:%SZ"))
