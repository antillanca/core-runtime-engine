#!/usr/bin/env python3
"""Materialize the frozen CORE v11.3.0 ContractProgram release manifest."""
...
from scripts.validate_frozen_release_manifest_v11_3_frozen import (  # noqa: E402
    RELEASE_VERSION,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build the frozen CORE v11.3.0 release manifest.")
    parser.add_argument("--frozen-at", required=True)
    parser.add_argument("--output", required=True, type=Path)
    args = parser.parse_args()
    try:
        payload = build_v11_3_frozen_manifest(args.frozen_at)
